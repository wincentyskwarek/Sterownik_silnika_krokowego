...
#define KR A4 //definicja pinu zmiany kierunku ruchu 
#define START 3 //definicja pinu zmiany start/stop 
#define SPEED A5 //definicja pinu zmiany NORMAL/MAX W NOWEJ WRSJI A0 -----------------------

// Definicja pinów wykonawczych TB6600
#define PUL 11 //definicja pinów pulsu
#define DIR 10 //definicja kierunków ruchu
#define ENA 9 //definicja zatrzymania wału

// definicja ustawień impulsatora
#define pinA A1  // podłączenie do CLK na KY-040
